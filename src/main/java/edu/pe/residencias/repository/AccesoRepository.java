...
public interface AccesoRepository extends JpaRepository<Acceso, Long> {
	...
	java.util.Optional<Acceso> findFirstByUsuarioIdAndDispositivoRelIdOrderByUltimaSesionDesc(Long usuarioId, Long dispositivoId);

	// Lookup by dispositivo fcm token via relation (most recent)
	java.util.Optional<Acceso> findFirstByUsuarioIdAndDispositivoRelFcmTokenOrderByUltimaSesionDesc(Long usuarioId, String fcmToken);
